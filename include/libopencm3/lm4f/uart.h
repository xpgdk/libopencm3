 ...
 *
 * The levels indicate how full the FIFO should be before
 * an interrupt is generated.
 * UART_FIFO_RX_TRIG_3_4 means that an interrupt is triggered
 * when the FIFO is 3/4 full. As the FIFO is 8 elements deep, 1/8
 * is equal to being triggered by a single character.
 */
 ...
 *
 * The levels indicate how empty the FIFO should be before
 * an interrupt is generated.
 * Note that this indicates the emptiness of the FIFO and not
 * the fullness. This is somewhat confusing, but it follows the
 * wording of the LM4F120H5QR datasheet.
 *
 * UART_FIFO_TX_TRIG_3_4 means that an interrupt is triggered
 * when the FIFO is 3/4 empty. As the FIFO is 8 elements deep, 7/8
 * is equal to being triggered by a single character.
 */
